        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <Link to="/" className="flex items-center">
              <span className="text-2xl font-bold text-indigo-500">StudyBuddy</span>
            </Link>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              {footerSections.features.map((item) => (
                <li key={item.name}>
                  <Link to={item.path} className="text-base text-gray-300 hover:text-white transition-colors duration-200">
                    {item.name}
                  </Link>
                </li>
              ))}
